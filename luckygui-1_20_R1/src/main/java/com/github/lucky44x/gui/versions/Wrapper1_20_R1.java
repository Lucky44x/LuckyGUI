...
public class Wrapper1_20_R1 extends VersionWrapper {
    ...
    public void sendOpenWindowPacket(Player user, int containerID, String inventoryTitle) {
        toNMS(user).c.a(new PacketPlayOutOpenWindow(containerID, Containers.h, IChatBaseComponent.a(inventoryTitle)));
    }

    @Override
    public void sendCloseWindowPacket(Player user, int containerID) {
        toNMS(user).c.a(new PacketPlayOutCloseWindow(containerID));
    }
