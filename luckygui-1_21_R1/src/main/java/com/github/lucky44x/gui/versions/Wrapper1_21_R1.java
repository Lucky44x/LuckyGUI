...
public class Wrapper1_21_R1 extends VersionWrapper {
    ...
    public void sendOpenWindowPacket(Player user, int containerID, String inventoryTitle) {
        toNMS(user).c.b(new PacketPlayOutOpenWindow(containerID, Containers.i, IChatBaseComponent.a(inventoryTitle)));
    }
